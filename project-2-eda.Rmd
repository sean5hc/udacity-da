Exploration of Red Wines by Eric Sean Turner
========================================================

### Initial Preparation
First we'll need to do a few things in preparation of exploring the data, such as setting the working directory and reading the data file into the environment. 
...
First, let's take a look at the dataset and see what variables are available. 
...
Let's see which of the variables are categorical or quantitative.
